        ...
        <>
            ...
            <Modal style={{ marginTop: "50px", display: "flex", alignItems: "center", flexDirection: "column" }} open={showModal} onClose={closeModal}>
                <>
                    ...
                    <Pagination hideNextButton={true} hidePrevButton={true} color="secondary" sx={{ "& .Mui-selected": { backgroundColor: "#d60565" } }} style={{ backgroundColor: "white" }} count={4} page={id + 1} onChange={(e) => setId(Number(e.target.textContent) - 1)} />
                </>
            </Modal>
        </>
    )
